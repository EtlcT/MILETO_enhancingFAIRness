...
METAEXTRA_ATT_PROPERTY = TEMP_CONF["meta_extra"]["tab_attr"]["property"]
METAEXTRA_ATT_VALUE = TEMP_CONF["meta_extra"]["tab_attr"]["value"]
METAEXTRA_PROP_SYNT = TEMP_CONF["meta_extra"]["properties"]["synthesis"]
METAEXTRA_PROP_DESC = TEMP_CONF["meta_extra"]["properties"]["description"]